...
export const InteractiveCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      const particleColor = isDark ? '139, 92, 246' : '99, 102, 241'; // violet
      const lineColor = isDark ? '167, 139, 250' : '148, 163, 184'; // violet / slate
  ...
  return (
    <canvas
      ref={canvasRef}
      className="pointer-events-none fixed inset-0 z-0 h-full w-full opacity-60 dark:opacity-40 transition-opacity duration-700"
      aria-hidden="true"
    />
  );
};

...
export const QuickAccessModal: React.FC<QuickAccessModalProps> = ({ isOpen, onClose, onOpenResume }) => {
  ...
  const navLinks = [
    { label: 'Projects', to: '/projects', icon: Layers, desc: '6 production applications & live demos' },
    { label: 'Skills & Tools', to: '/work/skills-and-tools', icon: Compass, desc: 'Languages, backend, AI/ML & databases' },
    { label: 'Experience', to: '/work/experience', icon: Briefcase, desc: 'Virtusa internship & achievements' },
    { label: 'Certifications', to: '/work/certifications', icon: Award, desc: 'Microsoft, AWS & Anthropic credentials' },
    { label: 'Today I Learned', to: '/today-i-learned', icon: BookOpen, desc: 'Engineering insights & architecture logs' },
    { label: 'Contact', to: '/work/contact', icon: Send, desc: 'Get in touch & direct channels' },
  ];
        ...
        <div className="mt-4 grid grid-cols-2 gap-2.5 sm:grid-cols-3">
          ...
          >
            ...
            <div className="overflow-hidden">
              ...
              <span className="truncate text-[10px] text-slate-500">{profileData.email}</span>
            </div>
          </button>
        </div>

        {/* Section Navigation List with React Router Link */}
        <div className="mt-5">
